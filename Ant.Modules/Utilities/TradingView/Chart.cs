...
{
    public abstract (Series atrStop, Series superTrend, object indicator, double histogram, double slope) UpdateFuturesIndicator(string code, Indicators? indicator = null);
